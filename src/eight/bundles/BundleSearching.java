...
//        defaultLocaleIrrelevant();
    ...
    private static void ignoreAmericaBundle() {
        ...
        ResourceBundle rb = ResourceBundle.getBundle("eight.bundles.Mill", us);
    ...
    private static void defaultLocaleIrrelevant() {
        ...
        ResourceBundle rb = ResourceBundle.getBundle("eight.bundles.Mill", localeCA);
        System.out.println(rb.getString("name"));
    }
}
