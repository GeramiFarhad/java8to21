...
public class MethodRefsAndContext {
    public static void main(String[] args) {
        // No eight.courses.Person being passed in => Supplier
        ...
        // One eight.courses.Person to be passed in => Function
        ...
        // Two eight.courses.Person's to be passed in => BiFunction
